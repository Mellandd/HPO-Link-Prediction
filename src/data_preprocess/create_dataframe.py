...
#    genes_locus, index_col = 'gene', encoders={
...
#gene_x, gene_mapping = load_node_csv(
#     genes_genomic, index_col='gene', encoders = {
#     "constitutiveexons" : IdentityEncoder(),
#     "ESTcount": IdentityEncoder(),
#     "alt3EST": IdentityEncoder(),
#     "alt5EST": IdentityEncoder(),
#     "alt3.5EST": IdentityEncoder(), 
#     "GeneLength": IdentityEncoder(),
#     "TranscriptCount": IdentityEncoder(),
#     "GCcontent": IdentityEncoder(),
#     "NumJunctions": IdentityEncoder(),
#     "IntronicLength": IdentityEncoder()
#})
...
torch.save(data, '/home/mellina/tfm/src/data/dataframe_exac_expr.pt')